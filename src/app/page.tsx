        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs md:text-sm">Privacy</a>
              <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs md:text-sm">Terms</a>
              <a href="#" className="text-muted-foreground hover:text-foreground transition-colors text-xs md:text-sm">Support</a>
            </div>
          </div>
        </div>
      </footer>
