...
export const metadata: Metadata = {
  ...
  description:
    "Join your lab room to share files with peers, send documents to the admin print queue, and collaborate in real time using secure, direct peer-to-peer connections on CosmoShare.",
  openGraph: {
